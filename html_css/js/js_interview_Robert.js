document.addEventListener("DOMContentLoaded", function () {
  ...
  const dialogData = [
    { name: "g2-team", text: "最初に就職活動してた時は、専攻と関連してエンタメ系、音楽とか映画とか映像とか、そういうのをやりたいなって思ってたんですけど、技術だったりとか、実際に何かしたっていうところがないと、やっぱり就職するのが難しくて、そっちの方面は途中で諦めて、その他に興味があったitっていうところにたどり着いた感じです。", annotation: "※コメント欄" },
    { name: "g2-team", text: "日本だと、専攻に関係なくても結構いろんなとこに就職することが新卒だったらできるので、そういうのもあってit業界に入りました。", annotation: "※コメント欄" },
    { name: "g2-team", text: "次のテキストを 추가하세요.", annotation: "※コメント欄" },
